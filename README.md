...
- `templates/`: copyable project files for new repositories.
- `examples/`: concrete contract and preflight examples.
...
3. For every shared feature, start with `templates/CONTRACT.template.md`.
4. Add one fast contract preflight before adding or relying on a long nightly test.
5. Split environments into local dev, scripted/fake-provider, local live, and production.
6. Move long-running workflows toward typed events, commands, activities, and current-state projections.
